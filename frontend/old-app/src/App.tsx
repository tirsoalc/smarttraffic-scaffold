    ...
    <div className="app-shell">
      ...
      <main id="main" className="dashboard">
        ...
        <div className="dashboard-grid">
            ...
            <div className="chart-shell">
              <ResponsiveContainer width="100%" height={280}>
                <BarChart data={hourData}>
                  ...
                  <XAxis dataKey="label" tickLine={false} axisLine={false} stroke="#9aa8aa" />
                  <YAxis tickLine={false} axisLine={false} stroke="#9aa8aa" />
                  <Tooltip cursor={{ fill: "rgba(255, 196, 0, 0.08)" }} />
                  <Bar dataKey="value" radius={[10, 10, 0, 0]}>
                    {hourData.map((entry, index) => (
                      <Cell
                        key={`${entry.label}-${index}`}
                        fill={index % 3 === 0 ? "#f7b500" : index % 3 === 1 ? "#2de1c2" : "#d8f3dc"}
                      />
                    ))}
                  </Bar>
                </BarChart>
            ...
            <div className="chart-shell">
              <ResponsiveContainer width="100%" height={280}>
                <BarChart data={weekdayData}>
                  ...
                  <XAxis dataKey="label" tickLine={false} axisLine={false} stroke="#9aa8aa" />
                  <YAxis tickLine={false} axisLine={false} stroke="#9aa8aa" />
                  <Tooltip cursor={{ fill: "rgba(45, 225, 194, 0.08)" }} />
                  <Bar dataKey="value" radius={[10, 10, 0, 0]} fill="#2de1c2" />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </Panel>
            ...
            <div className="chart-shell">
              <ResponsiveContainer width="100%" height={280}>
                <BarChart data={roadTypeData} layout="vertical" margin={{ left: 16 }}>
                  ...
                  <XAxis type="number" tickLine={false} axisLine={false} stroke="#9aa8aa" />
                  <YAxis dataKey="label" type="category" tickLine={false} axisLine={false} stroke="#9aa8aa" />
                  <Tooltip cursor={{ fill: "rgba(255, 255, 255, 0.04)" }} />
                  <Bar dataKey="value" radius={[0, 10, 10, 0]} fill="#f97316" />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </Panel>
          ...
          <Panel
            title="Map signals"
            subtitle="Current map endpoint returns region coordinates for display."
          >
            <div className="map-shell">
              <MapContainer center={[-23.5505, -46.6333]} zoom={11} scrollWheelZoom={false}>
                <TileLayer
                ...
                {dashboard.mapPoints.map((point) => (
                  <CircleMarker
                    ...
                    pathOptions={{ color: "#f7b500", fillColor: "#f97316", fillOpacity: 0.8 }}
                    radius={14}
                  >
                    <Popup>
